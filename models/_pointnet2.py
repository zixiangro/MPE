...
class get_model(nn.Module):
    def __init__(self, num_classes=40, return_feature=False, normal_channel=False):
...
class get_seg_model(nn.Module):
    def __init__(self, num_classes=50, return_feature=False, normal_channel=False):
        super(get_seg_model, self).__init__()
        if normal_channel:
    ...
    def forward(self, xyz, cls_label=None):
        ...
        if self.return_feature: return l3_points.view(B, 1024)
